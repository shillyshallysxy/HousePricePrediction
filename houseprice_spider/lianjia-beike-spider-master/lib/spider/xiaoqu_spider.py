...
from lib.spider.little_util import *
...
class XiaoQuBaseSpider(BaseSpider):
        ...
        for i in range(1, total_page + 1):
            ...
            for house_elem in house_elems:
                ...
                for fangzi_ in fangzi_list:
                    xiaoqu = XiaoQu(chinese_district, chinese_area, name, price,
                                    on_sale, house_developer, fangzi_)
    ...
    def start(self):
        ...
        # 准备线程池用到的参数
        nones = [None for _ in range(len(areas))]
        city_list = [city for _ in range(len(areas))]
